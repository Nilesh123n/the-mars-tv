  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-200 bg-[#D61F26] shadow-xl border-b border-red-700/60">
      <div className="max-w-[1440px] mx-auto px-3 sm:px-4 lg:px-6 w-full">
        <div className="flex items-center justify-between h-[64px] sm:h-[70px] gap-2 lg:gap-3">
          ...
          {/* Desktop Navigation Links (Cleanly rendered on desktop screens with zero cutoff) */}
            ...
            {navLinks.map((link) => {
              ...
              return (
                <button
                  ...
                  className={`
                    px-2.5 2xl:px-3 py-1.5 text-[12px] 2xl:text-[13px] font-bold transition-all duration-150 cursor-pointer rounded-xl flex items-center gap-1.5 whitespace-nowrap flex-shrink-0
                    ${
                      active
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 flex-shrink-0">
            ...
            <button
              ...
              className="bg-white hover:bg-gray-100 text-[#D61F26] px-2.5 sm:px-3.5 py-1.5 sm:py-2 rounded-xl text-[11.5px] sm:text-[12.5px] font-black transition-all flex items-center gap-1.5 shadow-md hover:shadow-lg active:scale-95 cursor-pointer whitespace-nowrap border border-white"
            ...
            >
              ...
              <span className="inline sm:hidden">List Property</span>
            </button>
            ...
            {/* Mobile / Tablet Menu Button (Visible on screens < 1280px / xl) */}
            <button
      ...
      {mobileOpen && (
        <div className="xl:hidden fixed inset-x-0 top-[64px] sm:top-[70px] bottom-0 bg-black/60 backdrop-blur-sm z-40 animate-in fade-in duration-200">
          <div className="bg-[#D61F26] border-t border-red-600/70 shadow-2xl max-h-[calc(100vh-68px)] overflow-y-auto animate-in slide-in-from-top-4 duration-200">
            <div className="max-w-[700px] mx-auto p-4 sm:p-6 space-y-4">
              
              {/* Top Banner: Quick List Property CTA */}
              <div className="bg-white/10 rounded-2xl p-3.5 sm:p-4 border border-white/20 flex flex-col sm:flex-row items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="w-full sm:w-auto bg-white hover:bg-gray-100 text-[#D61F26] px-4 py-2 rounded-xl text-xs font-extrabold flex items-center justify-center gap-2 shadow-md cursor-pointer active:scale-95 transition-all"
                >
              ...
              {/* Navigation Grid (2-Columns on Mobile/Tablet for clean alignment) */}
              <div>
              ...
              {/* Wishlist Link */}
              <div className="pt-2 border-t border-red-600/70">
                <button
                  onClick={() => handleNavClick('wishlist')}
                  className="w-full flex items-center justify-between p-3 rounded-xl bg-white/10 hover:bg-white/20 text-white text-xs font-bold border border-white/15 transition-all"
                >
