...
import { Heart, MapPin, BedDouble, Car, Maximize2, Search, SlidersHorizontal, ShieldCheck, Play } from 'lucide-react';
            ...
            {filtered.map((property) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-[18px] overflow-hidden border border-gray-200/90 shadow-[0_4px_18px_rgba(0,0,0,0.05)] hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-300 flex flex-col group cursor-pointer"
                >
